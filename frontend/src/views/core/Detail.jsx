                            ...
                            <div className="text-start text-lg-center mb-5" data-sticky="" data-margin-top={80} data-sticky-for={991}>
                                <div className="position-relative">
                                    <div className="avatar avatar-xl">
                                        <img className="avatar-img" style={{ width: "100px", height: "100px", objectFit: "cover", borderRadius: "50%" }} src="" alt="avatar" />
                                    </div>
                            ...
                            <div className="d-flex py-4">
                                <a href="#">
                                    <div className="avatar avatar-xxl me-4">
                                        <img className="avatar-img rounded-circle" src="#" style={{ width: "100px", height: "100px", objectFit: "cover", borderRadius: "50%" }} alt="avatar" />
                                    </div>
                                </a>
                                <div>
                                    ...
                                    <ul className="nav">
                                            ...
                                            <li className="nav-item">
                                                <a className="nav-link ps-0 pe-2 fs-5" target="_blank" href="#">
                                                    <i className="fab fa-facebook-square" />
                                                </a>
                                            </li>
                                        
                                       
                                            <a className="nav-link px-2 fs-5" target="_blank" href="#">
                                                <li className="nav-item">
                                ...
                                <h3>comments</h3>
                                    ...
                                    <div className="my-4 d-flex bg-light p-3 mb-3 rounded">
                                        ...
                                        <div>
                                            <div className="mb-2">
                                                <h5 className="m-0"></h5>
                                                <span className="me-3 small">Date</span>
                                            </div>
                            ...
                            <div className="bg-light p-3 rounded">
                                ...
                                <form className="row g-3 mt-2">
                                    <div className="col-md-6">
                                        ...
                                        <input name="full_name" value="" type="text" className="form-control" aria-label="First name" />
                                    </div>
                                    <div className="col-md-6">
                                        <label className="form-label">Email *</label>
                                        <input  name="email" value="" type="email" className="form-control" />
                                    </div>
                                    <div className="col-12">
                                        <label className="form-label">Write Comment *</label>
                                        <textarea  name="comment" value="" className="form-control" rows={4} />
                                    </div>
                                    <div className="col-12">
