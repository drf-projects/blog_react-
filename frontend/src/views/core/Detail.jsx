...
const handleCreateCommentChange=(event)=>{
    ...
    setCreateComment({...createComment,[event.target.name]:event.target.value})
               ...
               <ul className="list-inline text-primary-hover mt-0 mt-lg-3 text-start">
                 {tags?.map((tag,ind)=>(
                    <li className="list-inline-item">
                         <a className="text-body text-decoration-none fw-bold" href="#">{tag}</a>
                    </li>
                ))}
               </ul>
