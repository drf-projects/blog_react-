                                ...
                                <div className="card-header bg-transparent border-bottom p-3">
                                    <div className="d-sm-flex justify-content-between align-items-center">
                                        <h5 className="mb-2 mb-sm-0">
                                            All Blog Posts <span className="badge bg-primary bg-opacity-10 text-primary">length</span>
                                        </h5>
                                        ...
                                        <table className="table align-middle p-4 mb-0 table-hover table-shrink">
                                            ...
                                            <tbody className="border-top-0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <Link to="">
                                                                <img src="" style={{ width: "100px", height: "100px", objectFit: "cover", borderRadius: "10px" }} alt="" />
                                                            </Link>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>title</td>
                                                        <td>
                                                            <span className="badge bg-dark bg-opacity-10 text-dark mb-2">status</span>
                                                        </td>
                                                        <td>
                                                            <div className="d-flex gap-2">
                                                                <Link to="" className="btn btn-primary btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
