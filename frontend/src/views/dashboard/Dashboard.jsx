                ...
                <div className="container">
                    <div className="row g-4">
                                    ...
                                    <div className="row">
                                                <div className="col-12">
                                                    <div className="d-flex position-relative">
                                                        <img className="w-60 rounded" src="" style={{ width: "100px", height: "110px", objectFit: "cover", borderRadius: "10px" }} alt="product" />
                                                        <div className="ms-3">
                        ...
                        <div className="col-md-6 col-xxl-4">
                            <div className="card border h-100">
                                <div className="card-header border-bottom d-flex justify-content-between align-items-center  p-3">
                                    <h5 className="card-header-title mb-0">Comments </h5>
                                    <div className="dropdown text-end">
                                        <a href="#" className="btn border-0 p-0 mb-0" role="button" id="dropdownShare3" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <table className="table align-middle p-4 mb-0 table-hover table-shrink">
                                            ...
                                            <tbody className="border-top-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <span className="badge bg-dark bg-opacity-10 text-dark mb-2"></span>
                                                        </td>
                                                        <td>
